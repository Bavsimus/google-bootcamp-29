...
import 'package:libhub/ui/home/home_page_view.dart'; // Yeni ekranı import edin
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<AppBaseViewModel>.reactive(
      viewModelBuilder: () => getIt<
          AppBaseViewModel>(), // singleton: 1 instance of AppBaseViewModel
      ...
      builder: (context, viewModel, child) => MaterialApp(
        ...
        home:
            const HomePageView(), // Yeni ekranı başlangıç ekranı olarak ayarlayın
      ),
    );
  }
}
